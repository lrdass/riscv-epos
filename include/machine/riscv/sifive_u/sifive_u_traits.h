...
template <> struct Traits<Machine>: public Traits<Machine_Common>
{
    ...
    static const unsigned int VECTOR_TABLE      = 0x10001000;
    static const unsigned int PAGE_TABLES       = 0x89000000;
    static const unsigned int MEM_TOP           = 0x88000000;
    static const unsigned int BOOT_STACK        = 0x88000000;
    ...
    static const unsigned int APP_HIGH          = 0x88FFFFFF; //128mb

    static const unsigned int PHY_MEM           = 0x80000000;
    static const unsigned int IO_BASE           = 0x10010000;
    static const unsigned int IO_TOP            = 0x10011000;

    static const unsigned int SYS               = IO_TOP;
    static const unsigned int SYS_CODE          = IO_TOP;
    ...
    // PLL clocks
    static const unsigned int IO_PLL_CLOCK      = 0x3000000;
    static const unsigned int TIMER_CLOCK       =0x0200bff8;
};
