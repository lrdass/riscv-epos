// EPOS Virt (ARM Cortex-M3) GPIO Mediator Declarations

#ifndef __virt_gpio_h
#define __virt_gpio_h
...
public:
    ...
    //  { _gpio->pull(_pin_mask, p); }

    void int_enable() ; 
    // { _gpio->int_enable(_pin_mask); }
    ...
    void int_disable() ;
    // { _gpio->int_disable(_pin_mask); }
    void clear_interrupts();
    //  { _gpio->clear_interrupts(0xff); }
